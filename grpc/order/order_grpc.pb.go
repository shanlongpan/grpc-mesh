...
func (UnimplementedOrderServiceServer) Create(context.Context, *CreateOrderReq) (*CreateOrderResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedOrderServiceServer) Read(context.Context, *ReadOrderReq) (*ReadOrderResp, error) {
