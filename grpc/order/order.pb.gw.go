...
var (
	pattern_OrderService_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "order"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_OrderService_Read_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "order", "id"}, "", runtime.AssumeColonVerbOpt(true)))
)
